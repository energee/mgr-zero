...
## Done
- 2026-08-31 — Recipe development loop designed: version stores mash temp/efficiency/attenuation assumptions, server derives OG/FG/ABV (SCHEMA-GATE: assumption columns + material extract potential); per-batch actuals from readings via get_recipe_outcomes shown as deltas on the recipe.
