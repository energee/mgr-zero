...
- `content/docs/user-guide.html` is the master audience chooser;
- `content/docs/staff-guide.html` covers brewery staff only;
- `content/docs/portal-guide.html` covers wholesale portal users only.
