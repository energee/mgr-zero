...
- [ ] **Step 5:** Add the same **Push to QuickBooks** button (with the confirmation dialog) to `app/(app)/invoices/[id]/page.tsx`; update `docs/user-guide.md` (Integrations screen, push action, failure row, corrections) in the same commit.
