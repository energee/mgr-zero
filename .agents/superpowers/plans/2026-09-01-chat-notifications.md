...
- `docs/user-guide.md` — customer-facing setup, linking, delivery, quiet hours, privacy, and recovery.
...
```bash
git add .agents/ARCHITECTURE.md .agents/PROGRESS.md .agents/superpowers/specs docs/user-guide.md README.md
