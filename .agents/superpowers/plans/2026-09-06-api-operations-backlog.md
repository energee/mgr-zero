...
95 operations the screens declare they need that the command registry does not yet answer, against 69 that it does.
...
## Inventory & locations: 2 to build, 11 built
