...
29 operations the screens declare they need that the command registry does not yet answer, against 152 that it does.
...
## Team & brewery settings: 4 to build, 11 built
