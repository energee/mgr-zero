...
10 operations the screens declare they need that the command registry does not yet answer, against 201 that it does.
...
## Orders & invoicing: 1 to build, 26 built
