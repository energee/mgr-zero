...
| Any customer-visible screen, action, field, option, permission, result, error, or correction flow | `public/docs/user-guide.html` — served at `/docs/user-guide`; master link to separate staff and portal field manuals; update the applicable guide with the behavior |
