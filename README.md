...
- Documentation master: [`content/docs/user-guide.html`](content/docs/user-guide.html) (served at `/docs/user-guide`; links separate staff and customer-portal guides)
...
staff and portal field manuals linked from `content/docs/user-guide.html` when behavior has drifted. The
