...
export const SCREENS: Screen[] = [
  ...
  },
  {
    ...
    reads: "get_order · get_atp",
    writes: "submit_order [design; draft → submitted] · adjust_order_lines [design; one RPC: line + allocation; sets needs_restock on a picked order] · confirm_order [design; one RPC] · cancel_order [design; one RPC: terminal status + allocation release + needs_restock while quantities are staged]",
  ...
  },
  {
    ...
    reads: "daily_pick_sheet [design; confirmed orders by requested ship date, one fulfillment source]",
    writes: "none",
  ...
  },
  {
    ...
    writes: "create_brand · update_brand · create_sku · update_sku · upsert_price_list · set_price_list_item [existing/design]",
    states: DEFAULT_STATES,
