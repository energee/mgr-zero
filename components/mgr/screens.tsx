...
export const SCREENS: Screen[] = [
  // step 1 — foundations and both authenticated shells
  {
    ...
    spec: "Drawn as the warehouse persona at honest 16px density. Rows are role-filtered per plan §3. The restock row appears while orders.needs_restock is set and opens the order. Weekly count is gated: disabled with human copy, never a gate name.",
    body: today(<>
  ...
  },
  {
    ...
    spec: "Source writes required from_location_id; the app never guesses “Warehouse.” Save draft lands on the Order screen, where Submit lives.",
    body: (<>
