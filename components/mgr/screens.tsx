...
export const SCREENS: Screen[] = [
  ...
  },
  {
    ...
    writes: "configure_pos_menu · set_pos_price_override [nullable, per POS location] · set_pos_website_publication · publish_pos_menu [design; Program 14 P4 provider publication]",
