...
const eslintConfig = defineConfig([
  ...
  ]),
  {
    ...
    ignores: ["lib/supabase/admin.ts", "lib/supabase/integration-tokens.ts", "lib/supabase/invites.ts", "lib/supabase/provision.ts", "lib/supabase/public-menu.ts", "lib/chat/jobs.ts"],
    rules: {
