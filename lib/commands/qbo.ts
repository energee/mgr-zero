...
defineCommand({
  name: "disconnect_qbo", description: "Disable QuickBooks locally, purge its credential, and attempt remote revocation",
...
defineQuery({
  name: "get_qbo_connection", description: "Get redacted QuickBooks connection health",
