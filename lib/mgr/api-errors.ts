...
export const API_ERRORS: ApiError[] = [
  ...
  { code: "bad_request", status: 400, meaning: "A domain rule refused the write, such as shipping an order that was never picked, or a number was out of range for its field.",
