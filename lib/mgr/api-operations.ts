 ...
 * rather than orders because purchasing is listed first. content/docs/api/meta.json
 * orders the sidebar for a reader; the two orders are deliberately independent. */
export const API_AREAS = [
  ...
  { slug: "inventory", title: "Inventory & locations", match: /(movement|on_hand|atp|bin|location|count|inventory)/ },
  { slug: "customers", title: "Customers", match: /(customer|ship_to|portal_fulfillment)/ },
  { slug: "team", title: "Team & brewery settings", match: /(staff|team|invite|brewery|provision|first_run|operating_defaults|import_csv)/ },
