...
export const SCREEN_ROUTES: { name: string; file: string }[] = [
  ...
  { name: "Square → QuickBooks connector", file: "app/(app)/settings/pos/connector/page.tsx" },
  { name: "Disconnect Square", file: "app/(app)/settings/pos/disconnect/page.tsx" },
  { name: "POS mapping", file: "app/(app)/settings/pos/mapping/page.tsx" },
  { name: "POS sale detail", file: "app/(app)/settings/pos/sales/[id]/page.tsx" },
  { name: "Menu", file: "app/(app)/menu/page.tsx" },
  { name: "POS item", file: "app/(app)/menu/item/[formatId]/page.tsx" },
  { name: "Connect QuickBooks", file: "app/(app)/settings/accounting/connect/page.tsx" },
  { name: "Mapping conflict", file: "app/(app)/settings/accounting/qbo-controls.tsx" },
  { name: "QuickBooks mappings", file: "app/(app)/settings/accounting/mappings/page.tsx" },
  { name: "Invoice mappings", file: "app/(app)/invoices/[id]/mapping/page.tsx" },
  { name: "Disconnect QuickBooks", file: "app/(app)/settings/accounting/disconnect/page.tsx" },
  { name: "Fix mapping", file: "app/(app)/settings/accounting/qbo-controls.tsx" },
  ...
  { name: "Mash step", file: "components/mgr/views/mash-schedule.tsx" },
  { name: "Fermentation schedule", file: "app/(app)/recipes/[id]/schedule-sheets.tsx" },
  { name: "Fermentation stage", file: "components/mgr/views/fermentation-schedule.tsx" },
  { name: "Water", file: "app/(app)/recipes/[id]/schedule-sheets.tsx" },
  { name: "Water addition", file: "components/mgr/views/water.tsx" },
