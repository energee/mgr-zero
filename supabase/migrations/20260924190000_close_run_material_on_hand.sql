-- close_packaging_run draws its packaging BOM honestly (#436): a discrete
-- material (base uom 'each') is consumed in whole units, rounded up, and a
-- close whose draw exceeds what the finished-goods bin holds is refused rather
-- than driving the bin negative. Otherwise a copy of 20260923140000 (#432).
...
declare
  ...
  v_need numeric; v_on_hand numeric;
