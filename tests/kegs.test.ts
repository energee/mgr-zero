...
describe("keg pools and location-grain events", () => {
  ...
  it("refuses shipped without a customer and a bin outside the location", async () => {
...
describe("customer keg balance", () => {
  it("ship 4 halves, return 1, balance 3; no deposit invoiced reads 0 cents", async () => {
    ...
    // Shipping and returning do not change the fleet; they move kegs to and from the customer.
