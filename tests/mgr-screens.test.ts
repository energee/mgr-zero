...
describe("SCREENS", () => {
  ...
  it("keeps row actions to verbs", () => {
    const verbs = new Set([
      "Add", "Add stop", "Add to route", "Adjust", "Assign", "Change", "Check", "Close", "Confirm", "Connect", "Count", "Create",
      "Disconnect", "Edit", "Edit prices", "Finish", "Fix", "Forgot password?", "Invite", "Kick", "Map", "Open", "Open balance", "Open batch", "Open count",
      "Open in QuickBooks", "Open mapping", "Pay", "Pick", "Pick source", "Put back", "Reading", "Receive", "Release", "Reload", "Remove", "Reorder", "Re-push",
      "Resolve", "Resume", "Retry", "Review", "Review history", "Review sales", "Select", "Send", "Send PO", "Shortfall", "Start", "Swap", "Tap",
      "Unlink", "Use", "Write off",
    ]);
