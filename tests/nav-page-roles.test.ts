...
const PAGE_QUERIES: Record<string, readonly string[]> = {
  "/beer": ["get_beer_overview"],
  "/work": ["list_work"],
  "/settings": ["get_brewery", "list_locations", "list_team_members"],
  ...
  "/taproom": ["list_locations", "get_taproom_count_snapshot", "get_taproom_draft_projection", "list_taproom_counts", "get_taproom_count", "list_skus", "list_bins"],
};
